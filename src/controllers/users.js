...
const { getUsers, getUserById, getUsersPaginate, insertUser, updateUserBalance, updateUser, deleteUser, findUsers } = require('../models/users')
const upload = require("../helpers/multer")
const { getAllTransactionsByUserid, getTransactionsByUserid, getTransactionsByid, insertTransactions } = require('../models/transactions')
const { compareSync, hashSync, genSaltSync } = require('bcryptjs')
const { resSuccess, resFailure, OK, BADREQUEST, INTERNALSERVERERROR, CREATED, UNAUTHORIZED } = require('../helpers/status')
...
class Users {
  ...
  async uploadImage(req, res) {
    ...
    uploadImage(req, res, async (err) => {
      if (err)
        return resFailure(res, BADREQUEST, err.message)
